...
import 'package:edu_events/presentaion_layer/admin_screen/edit_event.dart';
import 'package:edu_events/presentaion_layer/admin_screen/edit_work_shop_screen.dart';
            ...
            Align(
              ...
              child: Padding(
                ...
                child: GestureDetector(
                  onTap: (){
                    Get.to(()=>EditEvent(model: eventModel));
                  },
                  child: Container(
                    height: 50,
                    alignment: AlignmentDirectional.center,
